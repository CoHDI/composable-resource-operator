...
require (
	...
	github.com/metal3-io/cluster-api-provider-metal3/api v1.13.2
...
require (
	...
	github.com/metal3-io/ip-address-manager/api v1.13.2 // indirect
...
replace (
	k8s.io/api => k8s.io/api v0.0.0-20250729200427-dd1e23428d50
	k8s.io/client-go => k8s.io/client-go v0.0.0-20250729225122-da11948805dd
)
